...
.stat-box {
    flex: 1;
    min-width: 180px;
    background: #FFE2C2; /* Light orange */
    padding: 18px;
    border-radius: 18px;
    border-left: 8px solid #FFA74A; /* Orange border */
    text-align: center;
    color: #6A3C00; /* Dark orange text */
    font-weight: 600;
...
/* Unpaid alert */
.alert-unpaid {
    background: #FFD5C5;        /* Soft orange/red */
    border-left: 8px solid #FF6D3D;
    color: #8A2B00;
}
...
.chart-card {
    ...
    border-radius: 18px;
    box-shadow: 0 3px 10px rgba(0, 0, 0, 0.08);
    border-left: 8px solid #FFB46B; /* Orange border */
    animation: fadeInUp 0.6s ease forwards;
    opacity: 0;
}
...
.top-list li {
    padding: 8px 0;
    border-bottom: 1px solid #F8D4A8; /* Light orange line */
    display: flex;
    ...
    <div class="main-content">
        ...
        <div class="chart-grid">
            ...
            <div class="chart-card" style="animation-delay:0.1s;">
                <h2>📊 Summons per Month (This Year)</h2>
        ...
        <!-- TOP VIOLATORS -->
        <div class="chart-card" style="animation-delay:0.2s; max-width: 600px;">
